...
PLUGINSLUG="vidsy"
CURRENTDIR=`pwd`
MAINFILE="vidsy.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/vidsy/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="TCattitude" # your svn username
