...
class VidsyWidgetPlaylistRecent extends WP_Widget
{
				function VidsyWidgetPlaylistRecent()
				{
								$widget_ops = array(
												'classname' => 'VidsyWidgetPlaylistRecent',
												'description' => 'Recent videos you have collected for a specific playlist, in a vertical display'
								);
								$this->WP_Widget('VidsyWidgetPlaylistRecent', 'VidsyTV: recent videos from single playlist', $widget_ops);
				}
...
?>
									<script type='text/javascript' src='//<?php
												echo VIDSY_DOMAIN; ?>/public/widgets/playlistvertical.js?userid=<?php
...
add_action('widgets_init', create_function('', 'return register_widget("VidsyWidgetPlaylistRecent");'));
