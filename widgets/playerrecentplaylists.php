...
class VidsyWidgetPlayerWithRecentPlaylists extends WP_Widget
{
				function VidsyWidgetPlayerWithRecentPlaylists()
				{
								$widget_ops = array(
												'classname' => 'VidsyWidgetPlayerWithRecentPlaylists',
												'description' => 'Displays a complete player with all recent videos been collected and your playlists'
								);
								$this->WP_Widget('VidsyWidgetPlayerWithRecentPlaylists', 'VidsyTV: player with recent videos and playlists', $widget_ops);
				}
...
?>
									<script type='text/javascript' src='//<?php echo VIDSY_DOMAIN; ?>/public/widgets/playerrecentplaylists.js?userid=<?php
...
add_action('widgets_init', create_function('', 'return register_widget("VidsyWidgetPlayerWithRecentPlaylists");'));
